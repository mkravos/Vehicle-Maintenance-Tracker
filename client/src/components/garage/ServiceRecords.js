                                ...
                                <Card className="col-sm-8 Card service-records-card" key={key}>
                                    <Card.Body>
                                        ...
                                        <div className="Card-text">
                                            ...
                                            {val.interval_time && days_difference > 0 && val.interval_miles && val.interval_miles - currMiles < 0 ? <div><span className="vehicleItem">Next Service: </span>Overdue by {(val.interval_miles - currMiles) * -1} miles and {days_difference} day(s)</div> : null}
