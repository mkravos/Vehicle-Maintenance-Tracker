...
export const addServiceItem = async (
  ...
  return instance
    .post<GenericResponse>("/api/maintenance/add", { ...serviceItem })
    .then((res) => {
      return res;
    })
    .catch((err) => {
...
export const listServiceItems = async (
  vehicleId: string,
): Promise<AxiosResponse<ServiceItem[] | GenericResponse>> => {
  return instance
    .get<ServiceItem[] | GenericResponse>(
      "/api/maintenance/list?vehicle_id=" + encodeURIComponent(vehicleId),
    )
    .then((res) => {
      return res;
    })
...
export const updateServiceItem = async (
  ...
  return instance
    .put<GenericResponse>("/api/maintenance/update", serviceItem)
    .then((res) => {
      return res;
    })
    .catch((err) => {
