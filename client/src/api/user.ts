...
export const login = async (
  ...
  return instance
    .post<LoginResponse | GenericResponse>("/api/user/login", {
      username: username,
      password: password,
...
export const register = async (
  ...
  return instance
    .post<GenericResponse>("/api/user/register", {
      username: username,
      password: password,
      recaptchaToken: recaptchaToken,
    })
...
export const verify = async (
  ...
  return instance
    .post<GenericResponse>("/api/user/verify", { token: token })
    .then((res) => {
      return res;
    })
    .catch((err) => {
...
export const updateUser = async (
  ...
  switch (action) {
    ...
    default:
      throw new Error(
        "invalid action supplied to updateUser call, must be: 'changePassword' or 'changeUsername'",
      );
  }

  return instance
    .put<GenericResponse>(url, body)
    .then((res) => {
      return res;
    })
    .catch((err) => {
...
export const getUserId = async (
  username: string,
): Promise<AxiosResponse<UserIdResponse | GenericResponse>> => {
  return instance
    .get<UserIdResponse | GenericResponse>(
      "/api/user/getId?username=" + encodeURIComponent(username),
    )
    .then((res) => {
      return res;
    })
